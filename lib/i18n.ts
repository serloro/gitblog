...
const translations: Translations = {
  en: {
    ...
    'settings.setupItem3': '• A "_posts" or "content/_posts" directory in your repository',
  ...
  es: {
    ...
    'settings.setupItem3': '• Un directorio "_posts" o "content/_posts" en tu repositorio',
